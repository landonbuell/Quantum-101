...
\paragraph*{}The momentum operator is represented in the \textit{x - basis} as:
\begin{equation}
\label{momentum}
\hat{p} = -i\hbar\frac{\partial}{\partial x}
\end{equation}
And the momentum operator acting on the state $\ket{\psi}$ would be notated as:
\begin{equation}
